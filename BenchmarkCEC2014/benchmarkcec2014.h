...
#ifndef BENCHMARKCEC2014_H
#define BENCHMARKCEC2014_H
#include <math.h>
#include <iostream>
#include <sstream>
#include <malloc.h>
#include <vector>
class BenchmarkCec2014
{
public:
    BenchmarkCec2014(int D);
    void cec14_test_func(double* x, double *f, int func_num);
    int getfOpt(int i);
private:
    ...
    int ini_flag,n_flag,func_flag,*SS, nx;
};

#endif // BENCHMARKCEC2014_H
